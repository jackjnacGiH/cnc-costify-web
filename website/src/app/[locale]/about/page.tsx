...
export default async function AboutPage({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* ── Hero ───────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-slate-50 pt-16 pb-20 md:pt-24 md:pb-28">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200 rounded-full text-sm font-bold text-blue-800 mb-8">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tight text-slate-900 mb-6">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">CNC</span>
            {isTh ? " ที่เข้าใจปัญหา " : " who understand "}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{isTh ? "โรงงานจริง" : "real factory pain"}</span>
          </h1>
