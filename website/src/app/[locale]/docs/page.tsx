      ...
      <section className="site-hero pt-16 pb-12 md:pt-24 md:pb-16">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="site-eyebrow mb-6">
            <BookOpen size={16} className="text-fuchsia-300" />
            {isTh ? "คู่มือการใช้งาน" : "User Documentation"}
          </div>

          <h1 className="site-hero-title text-4xl md:text-5xl font-black tracking-tight mb-4">
            {isTh ? "คู่มือ " : "Get started with "}
            <span className="site-hero-highlight">CNC Costify AI</span>
          </h1>
