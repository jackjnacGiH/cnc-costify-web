...
export default async function DownloadPage({ params }: Props) {
  ...
  return (
    <>
      <Navbar />
      <section className="site-hero py-16 md:py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <h1 className="site-hero-title text-4xl md:text-5xl font-black mb-4">
              {locale === "th" ? "ดาวน์โหลด CNC Costify AI" : "Download CNC Costify AI"}
            </h1>
            <p className="site-hero-copy text-lg">
              {locale === "th"
          ...
          {/* Download CTA */}
          <div className="site-surface rounded-2xl p-6 mb-8 text-slate-900">
          ...
          {/* System requirements */}
          <div className="site-surface rounded-2xl p-6 text-slate-900">
